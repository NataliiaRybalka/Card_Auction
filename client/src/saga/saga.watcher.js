...
import { getCardsWorker, createCardWorker, getCardsWithoutFilterWorker, getSoldUserCardsByIdWorker, getUserCardsWorker, getUserCardsWithoutFilterWorker } from "./cards.saga";
...
import { CREATE_CARD, REQUEST_CARDS, REQUEST_CARDS_WITHOUT_FILTER, REQUEST_SOLD_USER_CARDS, REQUEST_USER_CARDS, REQUEST_USER_CARDS_WITHOUT_FILTER } from "../redux/types/cards.types";
...
export function* sagaWatcher() {
  ...
  yield takeEvery(REQUEST_USER_CARDS_WITHOUT_FILTER, getUserCardsWithoutFilterWorker);
