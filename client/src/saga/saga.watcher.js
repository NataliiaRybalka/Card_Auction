...
import { registrationWorker, loginWorker, loginGoogleWorker, confirmEmailWorker, emailForRefreshPasswordWorker } from "./auth.saga";
...
import { LOGIN, REGISTRATION, LOGIN_GOOGLE, CONFIRM_EMAIL, REFRESH_PASSWORD } from "../redux/types/auth.types";
...
export function* sagaWatcher() {
  ...
  yield takeEvery(REFRESH_PASSWORD, emailForRefreshPasswordWorker);
